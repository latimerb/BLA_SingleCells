...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 kv /home/mizzou/BLA_SingleCells/Pyramidal/HOC/x86_64/kv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/BLA_SingleCells/Pyramidal/HOC/kv.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
