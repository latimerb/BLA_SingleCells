...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kap /home/mizzou/BLA_SingleCells/Pyramidal/HOC/x86_64/kaprox.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/BLA_SingleCells/Pyramidal/HOC/kaprox.mod";
static const char* nmodl_file_text = 
