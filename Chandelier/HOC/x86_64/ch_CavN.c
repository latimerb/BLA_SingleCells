...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 ch_CavN /home/mizzou/BLA_SingleCells/Chandelier/HOC/x86_64/ch_CavN.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/BLA_SingleCells/Chandelier/HOC/ch_CavN.mod";
static const char* nmodl_file_text = 
