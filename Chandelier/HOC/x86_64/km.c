...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 km /home/mizzou/BLA_SingleCells/Chandelier/HOC/x86_64/km.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/BLA_SingleCells/Chandelier/HOC/km.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
